...
var require_filesize = __commonJS({
  "node_modules/filesize/dist/filesize.cjs"(exports) {
    "use strict";
    var ARRAY = "array";
    var BIT = "bit";
    var BITS = "bits";
  ...
  "node_modules/@publishkit/pklib/dist/pklib.js"(exports, module2) {
    ...
    function gt() {
      if (_t)
        return H;
      _t = 1;
      var t2 = X().InputScanner, e2 = at().Tokenizer, n2 = at().TOKEN, r2 = lt().Directives, i2 = z(), s2 = st().Pattern, a2 = dt().TemplatablePattern;
      function o2(t3, e3) {
    ...
    function mt() {
      if (ht)
        return R;
      ht = 1;
      var t2 = N().Output, e2 = M().Token, n2 = z(), r2 = K().Options, i2 = gt().Tokenizer, s2 = gt().line_starters, a2 = gt().positionable_operators, o2 = gt().TOKEN;
      function u2(t3, e3) {
        return e3.indexOf(t3) !== -1;
      }
      function l2(t3, e3) {
    ...
    function zt() {
      if (jt)
        return Dt;
      jt = 1;
      var t2 = Lt().Options, e2 = N().Output, n2 = It().Tokenizer, r2 = It().TOKEN, i2 = /\r\n|[\r\n]/, s2 = /\r\n|[\r\n]/g, a2 = function(t3, n3) {
    ...
    function Pt() {
      ...
      var t2 = function() {
        if (pt)
          return T;
        pt = 1;
        var t3 = mt().Beautifier, e3 = K().Options;
        ...
        if (qt)
          return St;
        qt = 1;
        var t3 = zt().Beautifier, e3 = Lt().Options;
    ...
    Gt.realpathSync = function(t2, e2) {
      if (t2 = Kt.resolve(t2), e2 && Object.prototype.hasOwnProperty.call(e2, t2))
        return e2[t2];
      var n2, r2, i2, s2, a2 = t2, o2 = {}, u2 = {};
      function l2() {
        var e3 = Jt.exec(t2);
        n2 = e3[0].length, r2 = e3[0], i2 = e3[0], s2 = "", Vt && !u2[i2] && (Ht.lstatSync(i2), u2[i2] = true);
      }
      for (l2(); n2 < t2.length; ) {
        Qt.lastIndex = n2;
        var c2 = Qt.exec(t2);
        if (s2 = r2, r2 += c2[0], i2 = s2 + c2[1], n2 = Qt.lastIndex, !(u2[i2] || e2 && e2[i2] === i2)) {
          ...
          if (e2 && Object.prototype.hasOwnProperty.call(e2, i2))
            ...
            p2 === null && (Ht.statSync(i2), p2 = Ht.readlinkSync(i2)), _2 = Kt.resolve(s2, p2), e2 && (e2[i2] = _2), Vt || (o2[f2] = p2);
          }
          t2 = Kt.resolve(_2, t2.slice(n2)), l2();
        }
      }
      return e2 && (e2[a2] = t2), t2;
    }, Gt.realpath = function(t2, e2, n2) {
      if (typeof n2 != "function" && (n2 = Xt(e2), e2 = null), t2 = Kt.resolve(t2), e2 && Object.prototype.hasOwnProperty.call(e2, t2))
        return process.nextTick(n2.bind(null, null, e2[t2]));
      var r2, i2, s2, a2, o2 = t2, u2 = {}, l2 = {};
      function c2() {
        var e3 = Jt.exec(t2);
        r2 = e3[0].length, i2 = e3[0], s2 = e3[0], a2 = "", Vt && !l2[s2] ? Ht.lstat(s2, function(t3) {
          if (t3)
            return n2(t3);
          l2[s2] = true, _2();
        }) : process.nextTick(_2);
      ...
      function p2(t3, r3, i3) {
        if (t3)
          return n2(t3);
        var s3 = Kt.resolve(a2, r3);
        e2 && (e2[i3] = s3), f2(s3);
      }
      function f2(e3) {
        t2 = Kt.resolve(e3, t2.slice(r2)), c2();
      }
      c2();
    };
    var Yt = oe;
    ...
    var Te = (t2, e2, n2 = {}) => (Ue(e2), !(!n2.nocomment && e2.charAt(0) === "#") && new Ke(e2, n2).match(t2));
    var De = Te;
    var Re = le;
    Te.sep = Re.sep;
    ...
    Te.makeRe = (t2, e2) => new Ke(t2, e2 || {}).makeRe(), Te.match = (t2, e2, n2 = {}) => {
      const r2 = new Ke(e2, n2);
    ...
    !function(t2) {
      try {
        ...
        t2.exports = (Ve || (Ve = 1, typeof Object.create == "function" ? Xe.exports = function(t3, e4) {
    ...
    Un.encode = Kn, Un.decode = Zn, Un.format = function(t2) {
      var e2 = "";
    ...
    !function(t2) {
      ...
      var s2 = /\\([!"#$%&'()*+,\-.\/:;<=>?@[\\\]^_`{|}~])/g, a2 = new RegExp(s2.source + "|" + /&([a-z#][a-z0-9]{1,31});/gi.source, "gi"), o2 = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i, u2 = zn;
      var l2 = /[&<>"]/, c2 = /[&<>"]/g, _2 = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;" };
      function h2(t3) {
        return _2[t3];
      }
    ...
    var xr = {};
    var Er = In.unescapeAll;
    var Ar = In.unescapeAll;
    ...
    var Cr = In.assign;
    var Or = In.unescapeAll;
    var Sr = In.escapeHtml;
    var Tr = {};
    function Dr() {
      this.rules = Cr({}, Tr);
    }
    ...
    function Wr(t2) {
      var e2, n2, r2 = 0;
      for (e2 = t2.length - 1; e2 >= 0; e2--)
        (n2 = t2[e2]).type !== "text" || r2 || Ir.test(n2.content) && (n2.content = n2.content.replace(/\+-/g, "\xB1").replace(/\.{2,}/g, "\u2026").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1\u2014").replace(/(^|\s)--(?=\s|$)/gm, "$1\u2013").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1\u2013")), n2.type === "link_open" && n2.info === "auto" && r2--, n2.type === "link_close" && n2.info === "auto" && r2++;
    }
    var Gr = In.isWhiteSpace;
    var Kr = In.isPunctChar;
    var Vr = In.isMdAsciiPunct;
    var Hr = /['"]/;
    var Zr = /['"]/g;
        ...
        if (k2.length = b2 + 1, r2.type === "text") {
          ...
          t:
            for (; a2 < o2 && (Zr.lastIndex = a2, s2 = Zr.exec(i2)); ) {
              ...
              if (h2 = Vr(c2) || Kr(String.fromCharCode(c2)), p2 = Vr(_2) || Kr(String.fromCharCode(_2)), f2 = Gr(c2), (d2 = Gr(_2)) ? g2 = false : p2 && (f2 || h2 || (g2 = false)), f2 ? m2 = false : h2 && (d2 || p2 || (m2 = false)), _2 === 34 && s2[0] === '"' && c2 >= 48 && c2 <= 57 && (m2 = g2 = false), g2 && m2 && (g2 = h2, m2 = p2), g2 || m2) {
                if (m2) {
    ...
    var ii = [["normalize", function(t2) {
      ...
      if (t2.md.options.typographer)
        for (e2 = t2.tokens.length - 1; e2 >= 0; e2--)
          t2.tokens[e2].type === "inline" && (zr.test(t2.tokens[e2].content) && Ur(t2.tokens[e2].children), Ir.test(t2.tokens[e2].content) && Wr(t2.tokens[e2].children));
    ...
    for (qi = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i, Mi = In.isSpace, Fi = In.isSpace, Ii = [], zi = 0; zi < 256; zi++)
      Ii.push(0);
    var qi;
    var Mi;
    var Fi;
    ...
    var Wi = In.normalizeReference;
    var Gi = In.isSpace;
    var Ki = In.normalizeReference;
    var Vi = In.isSpace;
    ...
    var Qi = zn;
    var Ji = In.has;
    var Yi = In.isValidEntityCode;
    var ts = In.fromCodePoint;
    ...
    var is = Yr;
    var ss = In.isWhiteSpace;
    var as = In.isPunctChar;
    var os = In.isMdAsciiPunct;
    ...
    var _s = [["text", function(t2, e2) {
      ...
      return s2 = t2.src[o2], n2 >= 55296 && n2 <= 56319 && o2 + 1 < u2 && (r2 = t2.src.charCodeAt(o2 + 1)) >= 56320 && r2 <= 57343 && (s2 += t2.src[o2 + 1], o2++), i2 = "\\" + s2, e2 || (a2 = t2.push("text_special", "", 0), n2 < 256 && Ii[n2] !== 0 ? a2.content = s2 : a2.content = i2, a2.markup = i2, a2.info = "escape"), t2.pos = o2 + 1, true;
      ...
      if ((u2 = a2 + 1) < m2 && t2.src.charCodeAt(u2) === 40) {
        for (u2++; u2 < m2 && (r2 = t2.src.charCodeAt(u2), Vi(r2) || r2 === 10); u2++)
          ;
        if (u2 >= m2)
          return false;
        for (f2 = u2, (c2 = t2.md.helpers.parseLinkDestination(t2.src, u2, t2.posMax)).ok && (d2 = t2.md.normalizeLink(c2.str), t2.md.validateLink(d2) ? u2 = c2.pos : d2 = ""), f2 = u2; u2 < m2 && (r2 = t2.src.charCodeAt(u2), Vi(r2) || r2 === 10); u2++)
          ;
        if (c2 = t2.md.helpers.parseLinkTitle(t2.src, u2, t2.posMax), u2 < m2 && f2 !== u2 && c2.ok)
          for (_2 = c2.str, u2 = c2.pos; u2 < m2 && (r2 = t2.src.charCodeAt(u2), Vi(r2) || r2 === 10); u2++)
            ;
        else
          _2 = "";
        ...
        if (t2.env.references === void 0)
          return false;
        if (u2 < m2 && t2.src.charCodeAt(u2) === 91 ? (f2 = u2 + 1, (u2 = t2.md.helpers.parseLinkLabel(t2, u2)) >= 0 ? s2 = t2.src.slice(f2, u2++) : u2 = a2 + 1) : u2 = a2 + 1, s2 || (s2 = t2.src.slice(o2, a2)), !(l2 = t2.env.references[Ki(s2)]))
          return t2.pos = g2, false;
    ...
    ({ get exports() {
      ...
      var F2 = q2, I2 = O2("Object"), z2 = c2 && I2(new DataView(new ArrayBuffer(8))), P2 = typeof Map != "undefined" && I2(/* @__PURE__ */ new Map()), B2 = O2("DataView");
      function $2(t3) {
        return t3 != null && F2(t3.getInt8) && j2(t3.buffer);
      }
      var U2 = z2 ? $2 : B2, W2 = _2 || O2("Array");
      function G2(t3, e3) {
        return t3 != null && u2.call(t3, e3);
      }
      var K2 = O2("Arguments");
      !function() {
        K2(arguments) || (K2 = function(t3) {
          return G2(t3, "callee");
        });
      }();
      var V2 = K2;
      ...
      function ut2(t3) {
        if (t3 == null)
          return true;
        var e3 = it2(t3);
        return typeof e3 == "number" && (W2(t3) || S2(t3) || V2(t3)) ? e3 === 0 : it2(ot2(t3)) === 0;
      }
      function lt2(t3, e3) {
      ...
      function Qt2(t3, e3, n3) {
        return t3 == null ? Vt2 : F2(t3) ? Xt2(t3, e3, n3) : v2(t3) && !W2(t3) ? Ht2(t3) : Zt2(t3);
      }
      function Jt2(t3, e3) {
      ...
      function ve2(t3, e3, n3, r3, i3) {
        ...
        var s3 = It2(t3.prototype), a3 = t3.apply(s3, i3);
        return v2(a3) ? a3 : s3;
      }
      ...
      function Ke2(t3, e3, n3) {
        var r3 = (Ee2(t3) ? Pe2 : Ie2)(t3, e3, n3);
        if (r3 !== void 0 && r3 !== -1)
          return t3[r3];
      }
      function Ve2(t3, e3) {
        return Ke2(t3, Ht2(e3));
      }
      ...
      var cn2 = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;
      function _n2(t3) {
        return t3 ? W2(t3) ? a2.call(t3) : S2(t3) ? t3.match(cn2) : Ee2(t3) ? Ze2(t3, Vt2) : Tt2(t3) : [];
      }
      ...
      var $n2 = { __proto__: null, VERSION: t2, restArguments: k2, isObject: v2, isNull: w2, isUndefined: x2, isBoolean: A2, isElement: C2, isString: S2, isNumber: T2, isDate: D2, isRegExp: R2, isError: L2, isSymbol: N2, isArrayBuffer: j2, isDataView: U2, isArray: W2, isFunction: F2, isArguments: V2, isFinite: H2, isNaN: Z2, isTypedArray: rt2, isEmpty: ut2, isMatch: lt2, isEqual: dt2, isMap: At2, isWeakMap: Ct2, isSet: Ot2, isWeakSet: St2, keys: ot2, allKeys: gt2, values: Tt2, pairs: Dt2, invert: Rt2, functions: Lt2, methods: Lt2, extend: jt2, extendOwn: qt2, assign: qt2, defaults: Mt2, create: zt2, clone: Pt2, tap: Bt2, get: Gt2, has: Kt2, mapObject: te2, identity: Vt2, constant: X2, noop: ee2, toPath: $t2, property: Zt2, propertyOf: ne2, matcher: Ht2, matches: Ht2, times: re2, random: ie2, now: se2, escape: ue2, unescape: le2, templateSettings: ce2, template: ge2, result: me2, uniqueId: ye2, chain: ke2, iteratee: Jt2, partial: we2, bind: xe2, bindAll: Ce2, memoize: Oe2, delay: Se2, defer: Te2, throttle: De2, debounce: Re2, wrap: Le2, negate: Ne2, compose: je2, after: qe2, before: Me2, once: Fe2, findKey: Ie2, findIndex: Pe2, findLastIndex: Be2, sortedIndex: $e2, indexOf: We2, lastIndexOf: Ge2, find: Ke2, detect: Ke2, findWhere: Ve2, each: He2, forEach: He2, map: Ze2, collect: Ze2, reduce: Qe2, foldl: Qe2, inject: Qe2, reduceRight: Je2, foldr: Je2, filter: Ye2, select: Ye2, reject: tn2, every: en2, all: en2, some: nn2, any: nn2, contains: rn2, includes: rn2, include: rn2, invoke: sn2, pluck: an2, where: on2, max: un2, min: ln2, shuffle: pn2, sample: hn2, sortBy: fn2, groupBy: gn2, indexBy: mn2, countBy: bn2, partition: yn2, toArray: _n2, size: kn2, pick: wn2, omit: xn2, first: An2, head: An2, take: An2, initial: En2, last: On2, rest: Cn2, tail: Cn2, drop: Cn2, compact: Sn2, flatten: Tn2, without: Rn2, uniq: Ln2, unique: Ln2, union: Nn2, intersection: jn2, difference: Dn2, unzip: qn2, transpose: qn2, zip: Mn2, object: Fn2, range: In2, chunk: zn2, mixin: Bn2, default: ct2 }, Un2 = Bn2($n2);
      return Un2._ = Un2, Un2;
    }(), Vs = Xs, Hs = function(t2, e2, n2) {
      var r2, i2, s2, a2, o2, u2;
      return r2 = t2.utils.arrayReplaceAt, a2 = 0, s2 = { divWrap: false, divClass: "checkbox", idPrefix: "checkbox" }, e2 = Vs.extend(s2, e2), o2 = /\[(X|\s|\_|\-)\]\s(.*)/i, i2 = function(t3, n3, r3) {
        var i3, s3, o3;
    ...
    module2.exports = (_a = class {
      constructor(t2 = {}) {
        ...
        __publicField(this, "loadDirsConfig", async (t2) => {
          var _a2;
          const { vault: e2, utils: n2, kitrc: r2 } = this;
            ...
            for (const e3 of t3) {
              ...
              try {
                ...
                if (t4.path == "kitrc.md") {
                  ...
                  t4.content = JSON.stringify(e4, null, 2), t4.url = "kitrc.json", t4.type = "json", n2.index(t4);
                  continue;
                }
                ...
                this.kitrcfly = r2.o.merge({}, this.kitrc, ...u2, s3.frontmatter);
...
${t3.body}
        ...
        __publicField(this, "fileToAsset", async (t2) => {
          ...
          let r2 = "", i2 = "";
          n2 == "md" && (r2 = t2.replace(".md", ".html"), i2 = "md"), "jpg,jpeg,gif,png,svg,pdf".split(",").includes(n2) && (r2 = t2, i2 = n2 == "pdf" ? "pdf" : "image");
          return { path: t2, filename: e2, ext: n2, hash: await this.utils.c.getHash(r2), url: r2, type: i2 };
        });
        __publicField(this, "setKitrc", (t2) => {
          var _a2, _b;
          if (t2 = t2 || {}, !Object.keys(t2).length)
            throw new Error("inavalid kitrc data");
          __privateGet(this, _t2).call(this, "set:kitrc"), this.kitrc = t2, this.kitrcfly = {};
          const e2 = ((_a2 = t2.vault) == null ? void 0 : _a2.kit_folder) || this.env.kit;
          this.kit.setBase(e2), this.db.setBase(e2), this.version = ((_b = t2.pk) == null ? void 0 : _b.version) || "latest";
        });
        __publicField(this, "getKitrc", (t2, e2 = "md") => {
          const n2 = `${t2 || this.env.cwd}/kitrc.${e2}`;
        ...
        __publicField(this, "guessEnv", () => {
          ...
          try {
            ...
            t2 = process.cwd(), (jn.fs.existsSync(`${t2}/.obsidian`) || jn.fs.existsSync(`${t2}/kitrc.md`)) && (i2 = "vault");
          }
          try {
            i2 == "vault" ? (e2 = t2, r2 = this.getKitrc(t2), n2 = ((_a2 = r2.vault) == null ? void 0 : _a2.kit_folder) || `${t2}/kit`) : jn.fs.existsSync(`${t2}/kitrc.json`) ? (i2 = "kit", r2 = this.getKitrc(t2, "json"), n2 = t2) : (e2 = t2, i2 = "vault"), this.env = { cwd: t2, type: i2, vault: e2, kit: n2, isObsidian: s2 }, e2 && this.vault.setBase(e2), r2 && this.setKitrc(r2);
          } catch (t3) {
        ...
        __publicField(this, "betterError", (t2) => {
          let e2;
          return e2 = t2.name == "YAMLException" ? `Invalid Yaml in kitrc.md file. Fix & restart !

${t2.message}` : t2, e2;
        });
        this.utils = jn, this.vault = new qn(this, "vault"), this.kit = new qn(this, "kit"), this.parser = new Ys(this), this.db = new ra("kitdb"), t2.verbose && (this.verbose = true), this.guessEnv(), this.cfg = (t3, e2) => jn.o.get(this.kitrcfly, t3) || jn.o.get(this.kitrc, t3) || e2, this.cfg.set = (t3, e2) => jn.o.put(this.kitrcfly, t3, e2);
      }
      async createKitrc(t2 = {}) {
        var _a2, _b, _c, _d;
        if (this.env.type == "kit")
          throw new Error('cannot init a "kit" folder');
        if (await ((_a2 = this.vault) == null ? void 0 : _a2.fileExist("kitrc.md")))
          throw new Error("kitrc.md already exist");
        t2.vault = t2.vault || {}, t2.vault.kit_folder = t2.vault.kit_folder || ((_c = (_b = this.kitrc) == null ? void 0 : _b.vault) == null ? void 0 : _c.kit_folder) || `${this.env.vault}/kit`, t2.site = t2.site || {}, t2.site.name = t2.site.name || this.utils.s.capitalize((_d = this.env.vault.split("/").pop()) == null ? void 0 : _d.replace(/-/g, " ")), t2.site.id = t2.site.id || "";
        const e2 = ((t3 = {}) => `---

# \u{1F4C2} Vault

vault:
  kit_folder: ${t3.vault.kit_folder}
  include: 
...
Check out https://publishkit.dev`)(t2);
        return this.vault.write("kitrc.md", e2);
      }
    }, _t2 = new WeakMap(), _a);
  }
});
...
// src/report without_confirm.ts
var import_obsidian5 = require("obsidian");
var ReportModal2 = class extends import_obsidian5.Modal {
  constructor(pkplugin, callback) {
    super(app);
    this.pkplugin = pkplugin;
    this.callback = callback || (() => {
...
var PKPlugin = class extends import_obsidian6.Plugin {
  constructor() {
    ...
    this.startReportWithoutComfirm = () => {
      new ReportModal2(this).open();
    };
        ...
        txs.push([
          ...
          async (el) => {
            try {
              ...
              const path = filename && `${obs.getAttachementsFolder()}/${filename}`;
              const asset = path && await fileToAsset(path);
              if (!asset)
                return;
              parser.index(asset);
              ...
              $2(el).addClass("pdf");
              $2(el).empty().append(iframe);
              $2(body).find(".pdf-content-container").parent().remove();
              $2(body).find(".pdf-toolbar-left").parent().remove();
            } catch (e) {
              console.log("dsddd", e);
            }
          }
  ...
  async onload() {
    ...
    const iconCurrent = this.addRibbonIcon("paper-plane", "Darren's PublishKit", (evt) => {
      this.startLauncher();
    });
